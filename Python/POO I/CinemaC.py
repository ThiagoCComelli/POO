...
class Cinema():
    ...
    def getMaiorLucro(self):
        ...
        return 'Maior Lucro Possivel Sera de: R$ {}'.format(lucro)
...
film0.setDiretor(dire0)
film1.setDiretor(dire0)
film2.setDiretor(dire0)
film3.setDiretor(dire0)
film4.setDiretor(dire0)
film5.setDiretor(dire0)
sala0 = Sala(0,100)
sala1 = Sala(1,101)
sala2 = Sala(2,102)
sala3 = Sala(3,103)
...
sess1 = Sessao('28/04/3010 - 13:30',20)
sess2 = Sessao('28/04/3010 - 13:30',18)
sess3 = Sessao('28/04/3010 - 13:30',121)
sess4 = Sessao('28/04/3010 - 13:30',32)
sess5 = Sessao('28/04/3010 - 13:30',122)
sess6 = Sessao('28/04/3014 - 13:30',120)
