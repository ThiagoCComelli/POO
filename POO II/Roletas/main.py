...
class A:
    ...
    def apostas(self):
        ...
        ap12 = tkinter.Button(master=root,text="12",width=1,height=0,fg="red",bg="yellow",font="Times 13 bold").place(x=855,y=462)
        ap15 = tkinter.Button(master=root,text="15",width=1,height=0,fg="red",bg="yellow",font="Times 13 bold").place(x=950,y=462)
        ap18 = tkinter.Button(master=root,text="18",width=1,height=0,fg="red",bg="yellow",font="Times 13 bold").place(x=1051,y=462)
        ap21 = tkinter.Button(master=root,text="21",width=1,height=0,fg="red",bg="yellow",font="Times 13 bold").place(x=1145,y=462)
        ap24 = tkinter.Button(master=root,text="24",width=1,height=0,fg="red",bg="yellow",font="Times 13 bold").place(x=1242,y=462)
        ap27 = tkinter.Button(master=root,text="27",width=1,height=0,fg="red",bg="yellow",font="Times 13 bold").place(x=1340,y=462)
        ap30 = tkinter.Button(master=root,text="30",width=1,height=0,fg="red",bg="yellow",font="Times 13 bold").place(x=1436,y=462)
        ap33 = tkinter.Button(master=root,text="33",width=1,height=0,fg="red",bg="yellow",font="Times 13 bold").place(x=1533,y=462)
        ap36 = tkinter.Button(master=root,text="36",width=1,height=0,fg="red",bg="yellow",font="Times 13 bold").place(x=1630,y=462)

        ap2 = tkinter.Button(master=root, text="2", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=568, y=615)
        ap5 = tkinter.Button(master=root, text="5", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=663, y=615)
        ap8 = tkinter.Button(master=root, text="8", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=757, y=615)
        ap11 = tkinter.Button(master=root, text="11", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=855, y=615)
        ap14 = tkinter.Button(master=root, text="14", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=950, y=615)
        ap17 = tkinter.Button(master=root, text="17", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1051, y=615)
        ap20 = tkinter.Button(master=root, text="20", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1145, y=615)
        ap23 = tkinter.Button(master=root, text="23", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1242, y=615)
        ap26 = tkinter.Button(master=root, text="25", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1340, y=615)
        ap29 = tkinter.Button(master=root, text="29", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1436, y=615)
        ap32 = tkinter.Button(master=root, text="32", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1533, y=615)
        ap35 = tkinter.Button(master=root, text="35", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1630, y=615)

        ap1 = tkinter.Button(master=root, text="1", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=568, y=769)
        ap4 = tkinter.Button(master=root, text="4", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=663, y=769)
        ap7 = tkinter.Button(master=root, text="7", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=757, y=769)
        ap10 = tkinter.Button(master=root, text="10", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=855, y=769)
        ap13 = tkinter.Button(master=root, text="13", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=950, y=769)
        ap16 = tkinter.Button(master=root, text="16", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1051, y=769)
        ap19 = tkinter.Button(master=root, text="19", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1145, y=769)
        ap22 = tkinter.Button(master=root, text="22", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1242, y=769)
        ap25 = tkinter.Button(master=root, text="25", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1340, y=769)
        ap28 = tkinter.Button(master=root, text="28", width=1, height=0, fg="red", bg="yellow",font="Times 13 bold").place(x=1436, y=769)
